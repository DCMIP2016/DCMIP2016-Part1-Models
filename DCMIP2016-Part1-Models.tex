...
GEM & NH & $\vb{u}_h$, $w$, {\color{red}$\log \partial s / \partial \zeta$}, $\log T_v$, $\Phi$, $q$ & Yin-yang (\S \ref{sec:grid_yinyang}) & FV & C-grid  \\
